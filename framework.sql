...
(5, '2023_11_13_033027_create_pustakawans_table', 1),
(6, '2024_01_03_121546_create_books_table', 1);
...
--
-- Table structure for table `pustakawans`
--

CREATE TABLE `pustakawans` (
  `id_pustakawan` bigint(20) UNSIGNED NOT NULL,
  `username` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `pustakawan`
  MODIFY `id_pustakawan` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pustakawans`
--
ALTER TABLE `pustakawans`
  MODIFY `id_pustakawan` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `peminjaman`
  ADD CONSTRAINT `buku` FOREIGN KEY (`buku`) REFERENCES `bukus` (`id_buku`);

--
-- Constraints for table `rak`
--
ALTER TABLE `rak`
  ADD CONSTRAINT `bukuu` FOREIGN KEY (`buku`) REFERENCES `bukus` (`id_buku`);
COMMIT;
